Pod::Spec.new do |s|
  ...
  s.author       = { 'Nicolas CHENG' => 'nicolas.cheng.dev@gmail.com', 'Sam McEwan' => 'me@sammcewan.co.nz', 'Luis Portela Afonso' => 'luis.afonso@mindera.com' }

  s.source       = { :git => 'https://github.com/Mindera/WYPopoverController.git', :tag => '0.3.9' }
